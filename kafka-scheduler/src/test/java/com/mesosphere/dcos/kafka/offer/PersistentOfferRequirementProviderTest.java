...
public class PersistentOfferRequirementProviderTest {
  ...
  public void testNewRequirement() throws Exception {
    ...
    expectedEnvMap.put("KAFKA_JMX_OPTS", "-Dcom.sun.management.jmxremote=true -Dcom.sun.management.jmxremote.port=9010 -Dcom.sun.management.jmxremote.registry.ssl=true -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.ssl.need.client.auth=true -Dcom.sun.management.jmxremote.authenticate=false");
  ...
  public void testUpdateRequirement() throws Exception {
    ...
    final JmxConfig oldJmxConfig = new JmxConfig(true, KafkaTestUtils.testJMXPort, false, false);
