...
public class JmxConfig {
    ...
    public String getKafkaJmxOpts() {
        ...
        sb.append(this.getRemotePort());
        sb.append(BLANK);

        sb.append("-Dcom.sun.management.jmxremote.registry.ssl=");
        sb.append(this.isRemoteRegistrySsl());
        sb.append(BLANK);

        sb.append("-Dcom.sun.management.jmxremote.ssl=");
        sb.append(this.isRemoteSsl());
        sb.append(BLANK);

        if (this.getRemoteSslEnabledProtocols() != null) {
            sb.append("-Dcom.sun.management.jmxremote.ssl.enabled.protocols=");
            sb.append(this.getRemoteSslEnabledProtocols());
            sb.append(BLANK);
        }

        if (this.getRemoteSslEnabledCipherSuites() != null) {
            sb.append("-Dcom.sun.management.jmxremote.ssl.enabled.cipher.suites=");
            sb.append(this.getRemoteSslEnabledCipherSuites());
            sb.append(BLANK);
        }

        sb.append("-Dcom.sun.management.jmxremote.ssl.need.client.auth=");
        sb.append(this.isRemoteSslNeedClientAuth());
        sb.append(BLANK);

        sb.append("-Dcom.sun.management.jmxremote.authenticate=");
        sb.append(this.isRemoteAuthenticate());
        sb.append(BLANK);

        if (this.getRemotePasswordFile() != null) {
            sb.append("-Dcom.sun.management.jmxremote.password.file=");
            sb.append(this.getRemotePasswordFile());
            sb.append(BLANK);
        }

        if (this.getRemoteAccessFile() != null) {
            sb.append("-Dcom.sun.management.jmxremote.access.file=");
            sb.append(this.getRemoteAccessFile());
            sb.append(BLANK);
        }

        if (this.getRemoteLoginConfig() != null) {
            sb.append("-Dcom.sun.management.jmxremote.login.config=");
            sb.append(this.getRemoteLoginConfig());
            sb.append(BLANK);
        }
